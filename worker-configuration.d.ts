/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6476f7797958816bb0766e758b3208ff)
// Runtime types generated with workerd@1.20260116.0 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/entry.worker");
	}
	interface Env {
		BOOK_API_TOKEN: string;
		VITE_BUCKET_PUBLIC_URL: string;
		...
		r2: R2Bucket;
		db: D1Database;
		INDEX_BOOK_WORKFLOW: Workflow<Parameters<import("./src/entry.worker").IndexBookWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BOOK_API_TOKEN" | "VITE_BUCKET_PUBLIC_URL" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "db" | "DATABASE_URL">> {}
}
